package com.reviling.samra.filamentandroid.MainActivity
...
import com.reviling.androidfilament3d.ProfileScreen
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        customViewer.run {
            ...
            val i = Intent(applicationContext, ProfileScreen::class.java)
            startActivity(i)
